...
//        Collections.reverse(list);
    ...
    public StringAttribute getStringAttribute(String metricCode, Measurable measurable) throws Exception {
        return (StringAttribute) measurable.getVersionAttribute(attributeService.getAttributeTypeByCode(metricCode));
    }
