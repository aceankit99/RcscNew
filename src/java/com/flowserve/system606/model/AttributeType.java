...
public class AttributeType extends BaseEntity<Long> implements Comparable<AttributeType>, Serializable {

    private static final long serialVersionUID = -8382719960002472187L;
    private static final String DECIMAL_METRIC = "DecimalMetricVersion";
    public static final String CURRENCY_METRIC = "CurrencyMetricVersion";
    ...
    @SequenceGenerator(name = "ATTRIBUTE_TYPE_SEQ", sequenceName = "ATTRIBUTE_TYPE_SEQ", allocationSize = 1)
